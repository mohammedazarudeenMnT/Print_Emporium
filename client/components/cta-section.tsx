...
export default function CTASection({
  ...
  description = "Join 300+ companies who trust PrintEmporium",
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-8">
            ...
            >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-primary-700 text-white hover:bg-primary-800 hover:border-primary-600 h-14 px-8 rounded-2xl text-lg"
              >
                {secondaryButtonText}
              </Button>
            </motion.div>
